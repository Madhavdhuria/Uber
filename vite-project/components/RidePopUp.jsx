      ...
      <div className="flex items-center justify-between p-3 bg-yellow-400 rounded-lg mt-4">
        <div className="flex items-center gap-3">
          <img
            ...
            alt="Passenger"
          />
          <h2 className="text-lg font-medium">Madhav Dhuria</h2>
        </div>
        <h5 className="text-lg font-semibold">354 KM</h5>
      </div>
        ...
        <div className="w-full">
          <div className="flex items-center gap-5 p-3 border-b-2">
            ...
            <div>
              ...
              <p className="text-sm -mt-1 text-gray-600">Fazilka</p>
            </div>
          </div>
          <div className="flex items-center gap-5 p-3 border-b-2">
            ...
            <div>
              <h3 className="text-lg font-medium">562/11-A</h3>
              <p className="text-sm -mt-1 text-gray-600">Chandigarh</p>
            </div>
          </div>
          <div className="flex items-center gap-5 p-3">
            <i className="ri-currency-line"></i>
            <div>
              <h3 className="text-lg font-medium">₹707</h3>
